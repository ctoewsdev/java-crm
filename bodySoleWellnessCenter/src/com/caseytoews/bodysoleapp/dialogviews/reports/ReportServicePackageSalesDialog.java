...
public class ReportServicePackageSalesDialog extends JDialog {
	...
	public ReportServicePackageSalesDialog(JFrame frame, FilesReader filesReader) throws ApplicationException {
		setBounds(100, 100, 500, 350);
		setTitle("Monthly Sales: Package Services");
		setModal(true);
		setResizable(false);
		...
		{
			JLabel lblNewLabel = new JLabel("Monthly Totals for Package Services.");
...

		{
			...
			cancelButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					ReportServicePackageSalesDialog.this.dispose();
				}
			});
