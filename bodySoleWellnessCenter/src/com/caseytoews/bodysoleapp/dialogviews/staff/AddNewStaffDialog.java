...
public class AddNewStaffDialog extends JDialog {
	...
	public AddNewStaffDialog(JFrame frame, StaffDao staffDao) throws ApplicationException {
		super(frame, true);
		setModal(true);
		setResizable(false);
			...
			okButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if (!Validator.validateName(firstName)) {
						...
						Staff staff = new Staff(inputedPhone, firstName, lastName, textFieldEmail.getText(), startDate);

						try {

							AddNewStaffDialog.this.dispose();
							staffDao.addStaff(staff);
							MessagePopUp confirm = new MessagePopUp(frame, "Congratulations! \"" + firstName + " " + lastName + "\" has been added.",
									true);
							confirm.setVisible(true);

						} catch (Exception e) {
							LOG.error("ERROR in AddNewStaffDialog()");
